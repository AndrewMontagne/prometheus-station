...
#define LIGHTING_SOFT_THRESHOLD 0.0001 // If the max of the lighting lumcounts of each spectrum drops below this, disable luminosity on the lighting overlays.
