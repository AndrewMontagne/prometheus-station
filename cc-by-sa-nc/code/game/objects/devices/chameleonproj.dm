...
/obj/item/device/chameleon
	...
	afterattack(atom/target, mob/user , flag)
		if(istype(target,/obj/item))
			playsound(src, 'cc-by-sa-nc/sound/weapons/flash.ogg', 100, 1, 1)
	...
	proc/toggle()
		...
		if(active_dummy)
			playsound(src, 'cc-by-sa-nc/sound/effects/pop.ogg', 100, 1, 1)
			...
			T.icon = 'cc-by-sa-nc/icons/effects/effects.dmi'
			flick("emppulse",T)
			spawn(8) del(T)
		else
			playsound(src, 'cc-by-sa-nc/sound/effects/pop.ogg', 100, 1, 1)
