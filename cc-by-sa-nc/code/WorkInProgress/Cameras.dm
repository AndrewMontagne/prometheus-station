...
/obj/item/weapon/camera_test/afterattack(atom/target as mob|obj|turf|area, mob/user as mob, flag)
	...
	var/icon/photo = icon('cc-by-sa-nc/icons/misc/old_or_unused.dmi',"photo")
	...
	playsound(src.loc, pick('cc-by-sa-nc/sound/items/polaroid1.ogg','cc-by-sa-nc/sound/items/polaroid2.ogg'), 75, 1, -3)
