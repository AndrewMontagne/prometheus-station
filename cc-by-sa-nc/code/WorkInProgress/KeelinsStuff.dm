...
/area/beach
	...
	New()
		...
		mysound = S
		S.file = 'cc-by-sa-nc/sound/ambience/shore.ogg'
		S.repeat = 1
		S.wait = 0
		S.channel = 123
		S.volume = 100
	...
	proc/process()
		...
		var/sound_delay = 0
		if(prob(25))
			S = sound(file=pick('cc-by-sa-nc/sound/ambience/seag1.ogg','cc-by-sa-nc/sound/ambience/seag2.ogg','cc-by-sa-nc/sound/ambience/seag3.ogg'), volume=100)
...
/obj/item/weapon/beach_ball
	icon = 'cc-by-sa-nc/icons/misc/beach.dmi'
	icon_state = "ball"
	name = "beach ball"
	item_state = "clown"
	density = 0
...
/obj/fake_attacker/proc/proccess()
	...
	if(get_dist(src,my_target) > 1)
		...
		if(prob(15))
			if(weapon_name)
				my_target << sound(pick('cc-by-sa-nc/sound/weapons/genhit1.ogg', 'cc-by-sa-nc/sound/weapons/genhit2.ogg', 'cc-by-sa-nc/sound/weapons/genhit3.ogg'))
				...
				my_target << sound(pick('cc-by-sa-nc/sound/weapons/punch1.ogg','cc-by-sa-nc/sound/weapons/punch2.ogg','cc-by-sa-nc/sound/weapons/punch3.ogg','cc-by-sa-nc/sound/weapons/punch4.ogg'))
...
/proc/fake_blood(var/mob/target)
	...
	O.name = "blood"
	var/image/I = image('cc-by-sa-nc/icons/effects/blood.dmi',O,"floor[rand(1,7)]",O.dir,1)
	target << I
	spawn(300)
		del(O)
	return
