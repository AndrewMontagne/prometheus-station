...
// user interaction
/obj/machinery/disposal/proc/interact(mob/user, var/ai=0)
	...
	dat += "Pressure: [round(fakepressure, 1)]%<BR></body>"
...
/obj/machinery/disposal/process()
	...
	if(flush && fakepressure >= 100)	// flush can happen even without power
		flush()
	...
	fakepressure = min(100, fakepressure + 5)
