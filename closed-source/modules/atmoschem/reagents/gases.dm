...
/datum/chem/reagent/o2
	...
	molar_mass				= GRAMS(18)
	density_solid			= KGS_PER_LITRE(1.429)
	density_liquid			= KGS_PER_LITRE(1.146)


/datum/chem/reagent/n2
	name					= "nitrogen"
	key 					= "n2"
	...
	molar_mass				= GRAMS(28.014)
	density_solid			= KGS_PER_LITRE(1.251)
	density_liquid			= KGS_PER_LITRE(0.81)
...
/datum/chem/reagent/co2
	...
	latent_heat_of_vapour	= JOULES(384)
	latent_heat_of_fusion	= JOULES(205)
	std_melting_point		= CELSIUS(-56.56)
	std_boiling_point		= CELSIUS(-78.5)
	triple_point_pres		= KPA(517)
